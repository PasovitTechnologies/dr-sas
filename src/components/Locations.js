...
export default function Locations() {
  return (
    <section id="locations" className="bg-white py-12">
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        {/* Heading */}
        <div className="text-center mb-8">
          <h2 className="text-4xl font-semibold text-teal-900">
          ...
          {locations.map((location, index) => (
            ...
            >
              ...
              <div className="p-6 md:p-8 bg-white">
                ...
                <div className="flex gap-2 text-gray-600 mb-4 whitespace-pre-line">
